...
LesBus::LesBus(): LesVehicules() {
    ...
    Bus v1(2000, 72, 3.36, 18, "INTEGRO", "Mercedes", "Grise", "AC-000-AA", 2016, 110);
    Bus v2(4500, 102, 3.32, 19, "CITARO", "Mercedes", "Grise", "AC-001-AA", 2015, 130);
    Bus v3(7800, 46, 3.71, 18, "TRAVEGO", "Mercedes", "Grise", "AC-002-AA", 2014, 155);
